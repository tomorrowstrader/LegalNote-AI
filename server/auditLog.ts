...
export enum AuditEventType {
  ...
  // Solicitor reasoning layer
  DOCUMENT_GAPS_FILLED = "DOCUMENT_GAPS_FILLED",
  DOCUMENT_AML_CONFIRMED = "DOCUMENT_AML_CONFIRMED",
  DOCUMENT_VERIFICATION_WARNING_RESOLVED = "DOCUMENT_VERIFICATION_WARNING_RESOLVED",
}
