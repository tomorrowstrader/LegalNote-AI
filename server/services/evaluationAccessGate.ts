...
export const evaluationAccessGate: RequestHandler = async (req, res, next) => {
  ...
  try {
    ...
    return res.status(403).json({
      ...
      message:
        "Your governed evaluation period has ended. You can still view existing work, but new activity is disabled. Contact jazz.dennis@legalnote.ai to extend or subscribe.",
