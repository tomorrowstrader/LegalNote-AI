        ...
        >
          ...
          <div className={legalBodyClass}>
            ...
            <section>
              ...
              <h3 className={legalH3Class}>4.1 Account creation</h3>
              <p className="leading-relaxed">
                You must provide accurate information when creating or
                maintaining an account.
              </p>
              <h3 className={legalH3Class}>4.2 Authentication</h3>
              <p className="leading-relaxed">
              ...
              <h3 className={legalH3Class}>4.3 Firm accounts</h3>
              <p className="leading-relaxed">
              ...
              <h3 className={legalH3Class}>4.4 Account security</h3>
              <p className="leading-relaxed">
            ...
            <section>
              ...
              <h3 className={legalH3Class}>5.1 You may</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className={legalH3Class}>5.2 You may not</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              ...
              <h3 className={legalH3Class}>6.1 Your responsibility</h3>
              <p className="leading-relaxed">
              ...
              <h3 className={legalH3Class}>6.2 Consent features</h3>
              <p className="leading-relaxed">
            ...
            <section>
              ...
              <h3 className={legalH3Class}>7.1 Nature of AI output</h3>
              <p className="leading-relaxed">
                Transcripts and documents may contain errors, omissions,
                misattributions or inaccuracies.
              </p>
              <h3 className={legalH3Class}>7.2 Solicitor review required</h3>
              <p className="leading-relaxed">
            ...
            <section>
              ...
              <h3 className={legalH3Class}>8.1 Roles</h3>
              <p className="leading-relaxed">
              ...
              <h3 className={legalH3Class}>8.2 Data Processing Agreement</h3>
              <p className="leading-relaxed">
              ...
              <h3 className={legalH3Class}>8.3 Privacy and cookies</h3>
              <p className="leading-relaxed">
                Our{" "}
                <Link href="/privacy" className={legalLinkClass}>
                  Privacy Policy
              ...
              <h3 className={legalH3Class}>8.4 Sub-processors</h3>
              <p className="leading-relaxed">
            ...
            <section>
              ...
              <h3 className={legalH3Class}>9.4 Price changes</h3>
              <p className="leading-relaxed">
            ...
            <section>
              ...
              <h3 className={legalH3Class}>10.3 Feedback</h3>
              <p className="leading-relaxed">
            ...
            <section>
              ...
              <h3 className={legalH3Class}>13.1 Service warranty</h3>
              <p className="leading-relaxed">
              ...
              <h3 className={legalH3Class}>13.2 Limitation</h3>
              <p className="leading-relaxed">
              ...
              <h3 className={legalH3Class}>13.3 Exceptions</h3>
              <p className="leading-relaxed">
            ...
            <section>
              ...
              <h3 className={legalH3Class}>15.1 By you</h3>
              <p className="leading-relaxed">
              ...
              <h3 className={legalH3Class}>15.2 By us</h3>
              <p className="leading-relaxed">
              ...
              <h3 className={legalH3Class}>15.3 Effect</h3>
              <p className="leading-relaxed">
